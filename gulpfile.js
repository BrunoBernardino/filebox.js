...
gulp.task( 'less', function() {
    // TODO: bootstrap.css is getting style.css added in it as well
    return gulp
        .src([
...
gulp.task( 'watch', function() {
    // TODO: Not working
    watch( '/assets/public/css/**/*.less', function( files ) {
        runSequence( 'less' );
    });

    watch( '/assets/public/js/**/*.js', function( files ) {
        runSequence( 'usemin-css' );
    });
});
